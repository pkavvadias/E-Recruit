...
('admin', '12345', 'Pavel', 'Skiev', '2019-01-25 11:23:45', 'kalkav@ceid.bg')
;
...
('2019-02-01', 2000, 'data analyst', 'Patra, Greece', 'msmith', '2019-07-13', '2019-12-20');
...
CREATE TABLE interview (
  ...
  persscore INT(4) DEFAULT -1,
  edscore INT(4) DEFAULT 0,
  workexpscore INT(4) DEFAULT 0,
  comments VARCHAR(255) DEFAULT NULL,

  PRIMARY KEY (interview_id),
  KEY INTER_RECR (recruiter),
  KEY INTER_CAND (candidate),

  CONSTRAINT INTER_CAND FOREIGN KEY (candidate) REFERENCES candidate (username) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT INTER_RECR FOREIGN KEY (recruiter) REFERENCES recruiter (username) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT INTER_JOB FOREIGN KEY (job_id) REFERENCES job(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

INSERT INTO interview (
recruiter, candidate,  job_id,          intdate,            duration_hours,   persscore,     edscore,  workexpscore, comments) VALUES
('msmith', 'mnikol',    5,      '12-08-19 10:30:00',              2,             3,            0,          0,          "He has great knowledge and long work experience but was aggressive against me when facing difficulties.Needs more evaluation."),
('msmith', 'liagourma', 5,      '16-08-19 12:30:00',              1,             7,            7,          6,          "She was friendly and really qualified.Does not have enough work experience on our field but we can overcome this."),
('papad',   'lionarF',  2,      '18-08-19 13:00:00',              2,             6,            3,          6,          "Freddy is a nice guy with experience on our field.However he has no related degree"),
('msmith', 	'mnikol',	5, 		'11-08-19 10:30:00', 			  2, 			 7, 		   0, 		    0, 			"VER niceeeeee");
...
CREATE TABLE fields(
    ...
    PRIMARY KEY(title),
    CONSTRAINT FIELD_PARENT FOREIGN KEY (parent) REFERENCES fields(title) ON DELETE CASCADE ON UPDATE CASCADE
);

INSERT INTO fields (
title, description, parent)VALUES
("Computer Engineering", "Computer Science",                        NULL),
("Software",             "The non physical parts",                  "Computer Engineering"),
("Hardware",             "The physical parts",                      "Computer Engineering"),
("Operating Systems",    "The basis for every machine",             "Software"),
("Web Development",      "Cloud etc",                               "Software"),
("CPUs",                 "The core",                                "Hardware"),
("Microcontrollers",     "Teensy,arduino etc",                      "Hardware");

CREATE TABLE fields_per_company(
    company_afm CHAR(9) NOT NULL,
    field VARCHAR(25) NOT NULL,

    PRIMARY KEY(company_afm, field),
    CONSTRAINT SEC_PER_COMP_COMP FOREIGN KEY (company_afm) REFERENCES etaireia(AFM) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT SEC_PER_COMP_SEC FOREIGN KEY (field) REFERENCES fields(title) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE history (
  ...
  /*CONSTRAINT HISTORY_USER FOREIGN KEY (username) REFERENCES `user` (username) ON DELETE NO ACTION ON UPDATE CASCADE*/
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
